...
<head>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="FinishedGoods.css">
...
<body>
    ...
    <div class="banner-area">
        <header>
            <h1 class="heading">Finished Goods Department</h1>
        </header>
        ...
        <div class="container">
            <table class="table table-dark">
                ...
                <tbody>
                    ...
                    $database = 'omair_mairaj_17849';
                    $conn = mysqli_connect($serverName, $userName, $password, $database);
                    $select = "SELECT * FROM warranty_claim WHERE Status='Replacing'";
                    ...
                    ?>
                        <tr>
                            ...
                            <td width=110px align="center"><a class="btnstatus" type="submit" name="completebtn" onClick="return confirm('Confirm Completion?')" href="FinishedGoods.php?id=<?php echo $claim_id; ?>" value="Complete">Complete</a></td>
                        </tr>
                        </tr>
                    <?php } ?>
                </tbody>
